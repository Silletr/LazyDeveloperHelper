...
- [x] **Create a some.. Big update as for python installing libs** (_not python/requirements_installers/_\_req_install, but some file in python/ dir\*) (i mean - Ruby-gems installer)
